          ...
          <v-row>
            <v-col cols="12" sm="12" md="8" lg="8">
              <v-skeleton-loader type="card-avatar, article, actions" :loading="videoLoading" tile large>
                <v-responsive>
                  <iframe width="1000" height="400" :src="this.activeVideo.youtubeURL" frameborder="0"
                ...
                <v-card flat class="transparent">
                  ...
                  <div class="d-flex flex-wrap justify-space-between" id="btns">
                    <v-card-subtitle class="pl-0 pt-0 pb-0 subtitle-1" style="line-height: 2.4em;">
                      {{ this.activeVideo.views }} views<v-icon>mdi-circle-small</v-icon>{{ this.activeVideo.createdAt
                      }}
                    </v-card-subtitle>
                    ...
                    <v-card class="transparent" flat>
                      <v-list-item three-line to="/channel">
                        ...
                        <v-list-item-content class="align-self-auto">
                          <v-list-item-title class="font-weight-medium mb-1">Bouhriz Abir</v-list-item-title>
                          <v-list-item-subtitle>{{ this.activeVideo.subscribers }} subscribers
                  ...
                  <v-col>
                      ...
                      <v-list-item three-line class="pl-0">
                        ...
                        <v-list-item-content class="align-self-auto">
                          ...
                          <div v-if="showCommentBtns" class="d-inline-block text-right">
                            ...
                            <v-btn class="blue darken-3 white--text" depressed tile :disabled="comment === ''">Comment
                            </v-btn>
                          </div>
                        </v-list-item-content>
                      </v-list-item>
                    ...
                    <v-card class="transparent" flat v-for="i in 5" :key="i">
                      <v-list-item three-line class="pl-0 mt-2">
                        ...
                        <v-list-item-content>
                          <v-list-item-title class="font-weight-medium title mb-1">Bouhriz Abir
                            <span class="font-weight-light grey--text">
                              1 day ago</span>
                          </v-list-item-title>
                          <v-list-item-subtitle class="body-1">Lorem ipsum, dolor sit amet consectetur adipisicing
                          ...
                          <div class="d-none" :ref="`${'reply' + i}`">
                            <v-list-item three-line class="pl-0">
                              ...
                              <v-list-item-content class="align-self-auto mt-0 pt-0">
                                <v-form :ref="`form${i}`">
                                  <v-text-field :ref="`${'input' + i}`" class="pt-0 mt-0 body-2"
                                    placeholder="Add a public comment..." :value="repliesInput[`input${i}`]">
                                  </v-text-field>
                                </v-form>
                                <div :ref="i + 'btns'" class="d-inline-block text-right">
                                  <v-btn text @click="hideReply(i)" small>Cancel</v-btn>
                    ...
                    <v-card class="card transparent" flat :elevation="hover ? 1 : 0" style="cursor:pointer;">
                      <v-row no-gutters>
                        <v-col class="mx-auto" cols="3" sm="3" md="5" lg="5">
                          ...
                          <v-img class="align-center" :src="video.thumbnail">
                          </v-img>
                          <!-- </v-responsive> -->
                        </v-col>
                        <v-col>
